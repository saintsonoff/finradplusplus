...
## Использование
Конфигурирования правил для анализа из админ панели, доступны 4 вида правил: treshold (boolean condiditon), composite (treshold composition), pattert (SqlDB like filters), ml_rule (ml predictions)
