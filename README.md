...
Микросервис для анализа банковских транзакций и выявления мошеннической активности.
...
2.  **Запустите сервисы:**
    ...
    Эта команда соберёт и запустит все необходимые контейнеры. После завершения запуска API сервис будет доступен по адресу `https://localhost:8080`.
...
**Эндпоинт:**
- **URL:** `POST https://localhost:8080/transaction`
